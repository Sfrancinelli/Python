...
pantalla.grid(row=1, column=1, padx=4, pady=1, columnspan=4)
...
botonAC=Button(miFrame, text="AC",width=3,cursor="hand1",command=lambda:AC())
botonAC.grid(row=2,column=2,columnspan=2,padx=0,pady=0)
